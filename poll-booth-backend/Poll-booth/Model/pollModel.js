...
const CommentSchema = new Schema({
    ...
    likers: [{ type: mongoose.Schema.Types.ObjectId, ref: 'UserCollection' }], // Likes for comment
    replies: [] // Recursive replies will be added later
});


// Enable recursion AFTER schema creation
...
const PollSchema = new Schema({
    ...
    comments: [CommentSchema] // Recursive comments schema used here
});
